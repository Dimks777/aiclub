...
| Запрос | Файл |
|--------|------|
| CLI entry points и конфигурация | `references/package.json` |
| Автосубтитры (исходный код) | `references/auto-subs.js` |
| Автомонтаж (исходный код) | `references/auto-cut.js` |
| Полная сборка (исходный код) | `references/auto-assemble.js` |
