---
name: carousel
description: "Генерация Instagram каруселей — от бренд-кита до готовых PNG слайдов с текстом. Активируется на: carousel, карусель, карусели."
triggers:
  - карусель
  - carousel
  - instagram карусель
...
| Запрос | Файл |
|--------|------|
| Структура, хуки, формулы Hook/Body/CTA | Прочитай `references/carousel-structure.md` |
| Типы каруселей, выбор типа, auto-detect | Прочитай `references/carousel-types.md` |
| NanoBanana промпты, шаблоны, Style Lock | Прочитай `references/carousel-prompts.md` |
| CTA варианты, конверсия, дизайн | Прочитай `references/carousel-cta.md` |
| Скриншоты, GitHub OG, CSS, рендер | Прочитай `references/carousel-screenshots.md` |
| Бренд-кит пользователя | Прочитай `references/brand-kit.md` |
| Бренд-дефолты | Прочитай `references/brand-defaults.md` |
