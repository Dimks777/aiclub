...
description: "Обработка обучающих материалов (транскрипты курсов, вебинаров, мастермайндов, записи встреч). Автоматически определяет тематику, находит существующие скиллы и дополняет их, или предлагает создать новые. Активируется на: обработай, обучи, извлеки из, разбери материал, транскрипт, learn from, process."
triggers:
  - обучение
  - транскрипт
  - курс
...
| Запрос | Файл |
|--------|------|
| Правила определения тематики, маппинг тем на файлы | Прочитай `references/classification.md` |
| Шаблоны форматирования извлечённого контента | Прочитай `references/extraction-templates.md` |
...
Использовать `references/classification.md` для маппинга тем → файлов.
...
| PATTERN | Y | {project}/learning/patterns.md |
