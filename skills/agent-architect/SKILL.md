...
description: "Создание production-ready AI-агентов из простых запросов. Замена целых команд одним агентом. Активируется на: создай агента, агент для, новый агент, agent for, create agent, AI team, автоматизировать, команда агентов."
triggers:
  - создать агента
  - agent architect
  - новый агент
...
| Запрос | Файл |
|--------|------|
| patterns, orchestrator, worker, diagnostic | Прочитай `references/agent-patterns.md` |
| roles, team, responsibilities, capabilities | Прочитай `references/team-roles-library.md` |
| questions, interview, discovery | Прочитай `references/interview-questions.md` |
| quality, checklist, validation | Прочитай `references/quality-checklist.md` |
| anthropic, стандарт, best practices, валидация скилла, чеклист | Прочитай `references/anthropic-skills-guide.md` |
| automation, matrix, что автоматизировать | Прочитай `references/automation-matrix.md` |
| output, patterns, форматы вывода | Прочитай `references/output-patterns.md` |
| quality multipliers, множители качества | Прочитай `references/quality-multipliers.md` |
| team analysis, анализ команды | Прочитай `references/team-analysis.md` |
| workflows, процессы | Прочитай `references/workflows.md` |
| template, structure, format | Прочитай `references/agent-template.md` |
| team template, командный скилл | Прочитай `references/skill-template-team.md` |
...
See `references/interview-questions.md` for full guide.
...
1. Load `references/team-roles-library.md`
...
See `references/agent-patterns.md` for details.

---

### Phase 6: Generation

**Using `references/agent-template.md`:**
...
Before delivery, check against `references/quality-checklist.md`:
...
2. Analyze against `references/quality-checklist.md`
3. Identify gaps
