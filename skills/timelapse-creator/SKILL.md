...
description: "Создание AI-таймлапсов от идеи до готовых клипов. Активируется на: таймлапс, timelapse, переход между кадрами, трансформация, видео-переход."
triggers:
  - timelapse
  - таймлапс
  - AI таймлапс
...
Используй скилл `veo-video` для генерации видео.
